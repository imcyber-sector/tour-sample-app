<script lang="ts">
     ...
     import ContactForm from '../../components/contactForm/+page.svelte';
     ...
     const submitAndCloseContactForm = () => {
          ...
          if(!!!contactDetail.fullname || !!!contactDetail.emailAddress || !!!contactDetail.phoneNumber ) {
               return;
          }
          booking = {...booking, contact: contactDetail};
          console.log("booking : ",booking);

          goto('../../components/successPage');
     }
